...
using Homeappliences_application.Models;
...
namespace Homeappliences_application.Controllers
{
    ...
    {
        private MVC_testappEntities db = new MVC_testappEntities();
        ...
        public ActionResult Create([Bind(Include = "id,product1,category_id,brand_id,quantity,price")] product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,product1,category_id,brand_id,quantity,price")] product product)
        {
            if (ModelState.IsValid)
            {
